(function() {
  var DEFAULT_CONFIG, Denter, ESCAPES, SPACES, assert, attr_cmp, capture, collect, dent, escape, escape_attr, fs, ns_cmp, pi, read_config, spaces, ww, xmljs,
    slice = [].slice,
  ...
  read_config = function(opts, cb) {
    var config, ref;
    config = (ref = opts.config) != null ? ref : DEFAULT_CONFIG;
