(function() {
  ...
  Denter = (function() {
    ...
    Denter.prototype._print_element = function(node, out, parent_kind, indent) {
      var a, attrs, c, cap, decls, first, i, j, k, kind, l, len1, len2, len3, len4, new_indent, o, ref, ref1, ref2, rm, tot;
      ...
      if ((parent_kind != null ? parent_kind.mixed : void 0) && (((ref2 = node.nextSibling()) != null ? ref2.type() : void 0) === "text") && (!node.nextSibling().text().match(/^\./)) && (!node.nextSibling().text().match(/\xA0/))) {
        return out(" ");
      }
    };
